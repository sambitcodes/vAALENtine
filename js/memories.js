...
const MEMORY_DATA = [
    { title: "Where It All Began", image: "/pictures/memories/the last call/1.jpg", description: "It was just the end - the day after everything just sublimed. Had I any idea I wouldnt have let this call end." },
    { title: "Stronger Together", image: "/pictures/memories/the rough patch/2.jpg", description: "Every journey has its bumps, but we made it through together." },
    { title: "That Heartbeat Moment", image: "/pictures/memories/the first meeting/1.jpg", description: "Remember how serious I was at the reception as If I knew you forever. Hugging tightly for half an hour. WOWWWW!" },
    { title: "Coastal Dreams", image: "/pictures/memories/the mandarmani trip/5.jpg", description: "The sea breeze and the sound of waves at Mandarmani." },
    { title: "The Grand Return", image: "/pictures/memories/came back with a bang/1.jpg", description: "Month of silence and then we slowly grew back. We both tried for better." },
    { title: "Moonlight Serenade", image: "/pictures/memories/the last walk to remember/1.jpg", description: "Standing on the bridge looking at the beauty of moon, returning with paan." },
    { title: "Forever In Your Arms", image: "/pictures/memories/my forever together moment/1.jpg", description: "I still remember every small detail of that day, you holding me tight." },
    { title: "Chilli's Spice & Love", image: "/pictures/memories/a chillis date never disappoints/1.jpg", description: "Thank you for introducing me to this class of a restaurant. It's my favourite!" },
    { title: "First Heart To Heart", image: "/pictures/memories/when we talked for the first time/1.jpg", description: "The conversation that started it all." },
    { title: "Our First Milestone", image: "/pictures/memories/when we went on a trip for the first time/1.jpg", description: "Our first big adventure together." },
    { title: "Ocean Soul", image: "/pictures/memories/the mandarmani trip/2.jpg", description: "Another beautiful moment by the sea." },
    { title: "The Journey Logic", image: "/pictures/memories/when we went on a trip for the first time/2.jpg", description: "Capturing the joy of travel." },
    { title: "Side By Side", image: "/pictures/memories/my forever together moment/2.jpg", description: "Standing side by side, always." },
    { title: "Infinite Path", image: "/pictures/memories/the last walk to remember/2.jpg", description: "Exploring every corner of our world." },
    { title: "Late Night Echoes", image: "/pictures/memories/the last call/2.jpg", description: "Seconds felt like hours on those calls." },
    { title: "Seaside Soul", image: "/pictures/memories/the mandarmani trip/3.jpg", description: "The memories we made at the coast." },
    { title: "Fiery Flavors", image: "/pictures/memories/a chillis date never disappoints/2.jpg", description: "Back at our favorite spot!" },
    { title: "Healing Chapters", image: "/pictures/memories/the rough patch/3.jpg", description: "Growing stronger through every challenge." },
    { title: "Deep Soul Talk", image: "/pictures/memories/when we talked for the first time/2.jpg", description: "Finding so much in common." },
    { title: "Mandarmani Magic", image: "/pictures/memories/the mandarmani trip/4.jpg", description: "The beauty of the ocean matched our joy." },
    { title: "Bridge To Forever", image: "/pictures/memories/the last walk to remember/3.jpg", description: "Peaceful moments under the stars." },
    { title: "Unbreakable Bond", image: "/pictures/memories/my forever together moment/3.jpg", description: "A bond that can't be broken." },
    { title: "The Bang Return", image: "/pictures/memories/came back with a bang/2.jpg", description: "Starting a fresh chapter with a bang." },
    { title: "Where Magic Happens", image: "/pictures/memories/when we talked for the first time/3.jpg", description: "Where it all began..." }
];
